...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class U extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const W=function(e){const t=$(e);return j.encodeByteArray(t,!0)},B=function(e){return W(e).replace(/\./g,"")},H=function(e){try{return j.decodeString(e,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Un{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const n=new jn(Mt,e),i=new jn(Mt,t);return 0!==this.compare(n,i)}minPost(){return jn.MIN}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */let Wn;class Bn extends Un{static get __EMPTY_NODE(){return Wn}static set __EMPTY_NODE(e){Wn=e}compare(e,t){return Ft(e.name,t.name)}isDefinedOn(e){throw q("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return jn.MIN}maxPost(){return new jn(Lt,Wn)}makePost(e,t){return F("string"==typeof e,"KeyIndex indexValue must always be a string."),new jn(e,Wn)}toString(){return".key"}}const Hn=new Bn;
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */let ai;const li={};class hi{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return F(li&&ii,"ChildrenNode.ts has not been loaded"),ai=ai||new hi({".priority":li},{".priority":ii}),ai}get(e){const t=ae(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Yn?t:null}hasIndex(e){return oe(this.indexSet_,e.toString())}addIndex(e,t){F(e!==Hn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const s=t.getIterator(jn.Wrap);let r,o=s.getNext();for(;o;)i=i||e.isDefinedOn(o.node),n.push(o),o=s.getNext();r=i?oi(n,e.getCompare()):li;const a=e.toString(),l=Object.assign({},this.indexSet_);l[a]=e;const h=Object.assign({},this.indexes_);return h[a]=r,new hi(h,l)}addToIndexes(e,t){const n=he(this.indexes_,((n,i)=>{const s=ae(this.indexSet_,i);if(F(s,"Missing index implementation for "+i),n===li){if(s.isDefinedOn(e.node)){const n=[],i=t.getIterator(jn.Wrap);let r=i.getNext();for(;r;)r.name!==e.name&&n.push(r),r=i.getNext();return n.push(e),oi(n,s.getCompare())}return li}{const i=t.get(e.name);let s=n;return i&&(s=s.remove(new jn(e.name,i))),s.insert(e,e.node)}}));return new hi(n,this.indexSet_)}removeFromIndexes(e,t){const n=he(this.indexes_,(n=>{if(n===li)return n;{const i=t.get(e.name);return i?n.remove(new jn(e.name,i)):n}}));return new hi(n,this.indexSet_)}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
class fi extends Un{constructor(e){super(),this.indexPath_=e,F(!xn(e)&&".priority"!==In(e),"Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),i=this.extractChild(t.node),s=n.compareTo(i);return 0===s?Ft(e.name,t.name):s}makePost(e,t){const n=_i(e),i=ui.EMPTY_NODE.updateChild(this.indexPath_,n);return new jn(t,i)}maxPost(){const e=ui.EMPTY_NODE.updateChild(this.indexPath_,di);return new jn(Lt,e)}toString(){return kn(this.indexPath_,0).join("/")}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const gi=new class extends Un{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?Ft(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return jn.MIN}maxPost(){return jn.MAX}makePost(e,t){const n=_i(e);return new jn(t,n)}toString(){return".value"}};
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(e,((e,i)=>{Ri(i,new wn(t.toString()+"/"+e),n)}))}class Di{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Wt(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Ai{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Di(e);const n=1e4+2e4*Math.random();Yt(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;Wt(e,((e,i)=>{i>0&&oe(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),Yt(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Ui{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Wi(e,t,n,i,s,r){const o=i.filter((e=>e.type===n));o.sort(((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw q("Should only compare child_ events.");const i=new jn(t.childName,t.snapshotNode),s=new jn(n.childName,n.snapshotNode);return e.index_.compare(i,s)}
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(e,t,n))),o.forEach((n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,r);s.forEach((s=>{s.respondsTo(n.type)&&t.push(s.createEvent(i,e.query_))}))}))}function Bi(e,t){return{eventCache:e,serverCache:t}}function Hi(e,t,n,i){return Bi(new ji(t,n,i),e.serverCache)}function zi(e,t,n,i){return Bi(e.eventCache,new ji(t,n,i))}function Vi(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Yi(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Qi{constructor(e){this.writeTree_=e}static empty(){return new Qi(new Gi(null))}}function Ji(e,t,n){if(xn(t))return new Qi(new Gi(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const s=i.path;let r=i.value;const o=Rn(s,t);return r=r.updateChild(o,n),new Qi(e.writeTree_.set(s,r))}{const i=new Gi(n),s=e.writeTree_.setTree(t,i);return new Qi(s)}}}function Xi(e,t,n){let i=e;return Wt(n,((e,n)=>{i=Ji(i,Pn(t,e),n)})),i}function Zi(e,t){if(xn(t))return Qi.empty();{const n=e.writeTree_.setTree(t,new Gi(null));return new Qi(n)}}function es(e,t){return null!=ts(e,t)}function ts(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(Rn(n.path,t)):null}function ns(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(ii,((e,n)=>{t.push(new jn(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new jn(e,n.value))})),t}function is(e,t){if(xn(t))return e;{const n=ts(e,t);return new Qi(null!=n?new Gi(n):e.writeTree_.subtree(t))}}function ss(e){return e.writeTree_.isEmpty()}function rs(e,t){return os(bn(),e.writeTree_,t)}function os(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,s)=>{".priority"===t?(F(null!==s.value,"Priority writes must always be leaf nodes"),i=s.value):n=os(Pn(e,t),s,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(Pn(e,".priority"),i)),n}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const bs=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class Is{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new ji(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return ys(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Yi(this.viewCache_),s=ms(this.writes_,i,t,1,n,e);return 0===s.length?null:s[0]}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
class Wr{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Br(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Dn(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Hr(e,t,n){Br(e,n),Vr(e,(e=>Dn(e,t)))}function zr(e,t,n){Br(e,n),Vr(e,(e=>An(e,t)||An(t,e)))}function Vr(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(Yr(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Yr(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();kt&&Pt("event: "+n.toString()),Vt(i)}}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(n,...e)}return n}function qo(e,t,n){const i=e.slice();return i[11]=t[n],i}function $o(e){let t,n,s,r,o,a,m,y,v,C,w,b,I,E,T,S=`Score = ${e[1][e[11].index]}`;function k(){return e[4](e[11])}function N(){return e[5](e[11])}return{c(){t=d("div"),n=d("div"),s=d("button"),s.textContent="Yes",r=_(),o=d("button"),o.textContent="No",a=_(),m=d("img"),v=_(),C=d("span"),w=p(S),g(s,"class","svelte-hy33j8"),g(o,"class","svelte-hy33j8"),g(n,"class","buttons svelte-hy33j8"),l(m.src,y=e[11].src)||g(m,"src",y),g(m,"alt","jsp"),g(m,"class","svelte-hy33j8"),g(C,"class","svelte-hy33j8"),g(t,"class","box svelte-hy33j8"),g(t,"id",b=`box-${e[11].index}`),g(t,"style",I=`background-color: ${e[11].bgColor}`)},m(e,i){c(e,t,i),h(t,n),h(n,s),h(n,r),h(n,o),h(t,a),h(t,m),h(t,v),h(t,C),h(C,w),E||(T=[f(s,"click",k),f(o,"click",N)],E=!0)},p(n,i){e=n,1&i&&!l(m.src,y=e[11].src)&&g(m,"src",y),3&i&&S!==(S=`Score = ${e[1][e[11].index]}`)&&function(e,t){t=""+t,e.data!==t&&(e.data=t)}(w,S),1&i&&b!==(b=`box-${e[11].index}`)&&g(t,"id",b),1&i&&I!==(I=`background-color: ${e[11].bgColor}`)&&g(t,"style",I)},d(e){e&&u(t),E=!1,i(T)}}}function jo(t){let n,i,s,r,o,a,l,p=t[0],m=[];for(let e=0;e<p.length;e+=1)m[e]=$o(qo(t,p,e));return{c(){n=d("main"),i=d("a"),i.innerHTML='<img id="bs" src="https://www.animeunited.com.br/oomtumtu/2023/03/portada_oshi-no-ko-17.jpg" alt="scantrad" class="svelte-hy33j8"/> \n    <p id="mac" class="svelte-hy33j8">Bas de page</p>',s=_();for(let e=0;e<m.length;e+=1)m[e].c();r=_(),o=d("a"),o.innerHTML='<div class="svelte-hy33j8"></div>',g(i,"href","#"),g(i,"class","svelte-hy33j8"),g(o,"id","bas"),g(o,"class","svelte-hy33j8"),g(n,"class","svelte-hy33j8")},m(e,t){c(e,n,t),h(n,i),h(n,s);for(let e=0;e<m.length;e+=1)m[e]&&m[e].m(n,null);h(n,r),h(n,o),a||(l=f(i,"click",Uo),a=!0)},p(e,[t]){if(15&t){let i;for(p=e[0],i=0;i<p.length;i+=1){const s=qo(e,p,i);m[i]?m[i].p(s,t):(m[i]=$o(s),m[i].c(),m[i].m(n,r))}for(;i<m.length;i+=1)m[i].d(1);m.length=p.length}},i:e,o:e,d(e){e&&u(n),function(e,t){for(let n=0;n<e.length;n+=1)e[n]&&e[n].d(t)}(m,e),a=!1,l()}}}function Uo(){window.scrollTo({top:document.body.scrollHeight,behavior:"smooth"})}function Wo(e,t,n){let i=[{src:"https://pbs.twimg.com/media/FlyK1nFaYAA1hJC.jpg"},{src:"https://m.media-amazon.com/images/I/71bgnycGk6L.jpg"},{src:"https://www.manga-news.com/public/images/vols/Oshi-no-Ko-11-jp.jpg"},{src:"https://www.manga-news.com/public/images/dvd/oshi-no-ko-anime-visual-2.jpg"},{src:"https://preview.redd.it/fcy3hcdm6y281.jpg?auto=webp&s=b00dcfd6cbc8dcf4c8bc531e1cc7a336f9beca18"}];const s=Fo(tt({apiKey:"AIzaSyCSUQoYmYbmbkKoIbDQcQhOxnada13rBWY",authDomain:"memory-c1192.firebaseapp.com",projectId:"memory-c1192",storageBucket:"memory-c1192.appspot.com",messagingSenderId:"320978503728",appId:"1:320978503728:web:49c1ef1f72cd9a595745f5",measurementId:"G-QP4M89SW8F",databaseURL:"https://memory-c1192-default-rtdb.europe-west1.firebasedatabase.app/"}));let r=Array(i.length).fill(0);i=i.map(((e,t)=>({...e,bgColor:`rgb(${Math.floor(256*Math.random())}, ${Math.floor(256*Math.random())}, ${Math.floor(256*Math.random())}, 0.6)`,index:t})));let o=!0,a=!0;function l(e){!1!==o&&(o=!1,r[e],ko(To(s,`images/${e}`),r[e]+30),setTimeout((()=>{o=!0}),100))}function h(e){!1!==a&&(a=!1,r[e],ko(To(s,`images/${e}`),r[e]-30),setTimeout((()=>{a=!0}),100))}y((()=>{!function(e,t,n,i){xo(e,"value",t,n,i)}(To(s,"images"),(e=>{const t=e.val();t&&n(1,r=Object.values(t))}))}));return[i,r,l,h,e=>{l(e.index)},e=>{h(e.index)}]}$n.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},$n.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},function(e){!function(e){mt=e}("9.20.0"),Xe(new ge("database",((e,{instanceIdentifier:t})=>Oo(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),nt(ft,gt,e),nt(ft,gt,"esm2017")}();return new class extends O{constructor(e){super(),A(this,e,Wo,jo,r,{})}}({target:document.body,props:{name:"world"}})}();
