...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(n,...e)}return n}function $o(e,t,n){const i=e.slice();return i[13]=t[n],i}function Uo(e){let t,n,s,r,o,a,m,y,v,C,w,b,I,E,T,S=`Score = ${e[1][e[13].index]}`;function k(){return e[5](e[13])}function N(){return e[6](e[13])}return{c(){t=d("div"),n=d("div"),s=d("button"),s.textContent="Yes",r=_(),o=d("button"),o.textContent="No",a=_(),m=d("img"),v=_(),C=d("span"),w=p(S),g(s,"class","svelte-1nmp7fr"),g(o,"class","svelte-1nmp7fr"),g(n,"class","buttons svelte-1nmp7fr"),l(m.src,y=e[13].src)||g(m,"src",y),g(m,"alt","jsp"),g(m,"class","svelte-1nmp7fr"),g(C,"class","svelte-1nmp7fr"),g(t,"class","box svelte-1nmp7fr"),g(t,"id",b=`box-${e[13].index}`),g(t,"style",I=`background-color: ${e[13].bgColor}`)},m(e,i){c(e,t,i),h(t,n),h(n,s),h(n,r),h(n,o),h(t,a),h(t,m),h(t,v),h(t,C),h(C,w),E||(T=[f(s,"click",k),f(o,"click",N)],E=!0)},p(n,i){e=n,1&i&&!l(m.src,y=e[13].src)&&g(m,"src",y),3&i&&S!==(S=`Score = ${e[1][e[13].index]}`)&&function(e,t){t=""+t,e.wholeText!==t&&(e.data=t)}(w,S),1&i&&b!==(b=`box-${e[13].index}`)&&g(t,"id",b),1&i&&I!==(I=`background-color: ${e[13].bgColor}`)&&g(t,"style",I)},d(e){e&&u(t),E=!1,i(T)}}}function Wo(t){let n,i,s,r,o,a,l,p=t[0],m=[];for(let e=0;e<p.length;e+=1)m[e]=Uo($o(t,p,e));return{c(){n=d("main"),i=d("a"),i.innerHTML='<img id="bs" src="https://www.animeunited.com.br/oomtumtu/2023/03/portada_oshi-no-ko-17.jpg" alt="scantrad" class="svelte-1nmp7fr"/> \n    <p id="mac" class="svelte-1nmp7fr">Bas de page</p>',s=_();for(let e=0;e<m.length;e+=1)m[e].c();r=_(),o=d("a"),o.innerHTML='<div class="svelte-1nmp7fr"></div>',g(i,"href","#"),g(i,"class","svelte-1nmp7fr"),g(o,"id","bas"),g(o,"class","svelte-1nmp7fr"),g(n,"class","svelte-1nmp7fr")},m(e,t){c(e,n,t),h(n,i),h(n,s);for(let e=0;e<m.length;e+=1)m[e]&&m[e].m(n,null);h(n,r),h(n,o),a||(l=f(i,"click",jo),a=!0)},p(e,[t]){if(31&t){let i;for(p=e[0],i=0;i<p.length;i+=1){const s=$o(e,p,i);m[i]?m[i].p(s,t):(m[i]=Uo(s),m[i].c(),m[i].m(n,r))}for(;i<m.length;i+=1)m[i].d(1);m.length=p.length}},i:e,o:e,d(e){e&&u(n),function(e,t){for(let n=0;n<e.length;n+=1)e[n]&&e[n].d(t)}(m,e),a=!1,l()}}}function jo(){window.scrollTo({top:document.body.scrollHeight,behavior:"smooth"})}function Bo(e,t,n){let i=[{src:"https://pbs.twimg.com/media/FlyK1nFaYAA1hJC.jpg"},{src:"https://m.media-amazon.com/images/I/71bgnycGk6L.jpg"},{src:"https://www.manga-news.com/public/images/vols/Oshi-no-Ko-11-jp.jpg"},{src:"https://www.manga-news.com/public/images/dvd/oshi-no-ko-anime-visual-2.jpg"},{src:"https://preview.redd.it/fcy3hcdm6y281.jpg?auto=webp&s=b00dcfd6cbc8dcf4c8bc531e1cc7a336f9beca18"}];const s=qo(tt({apiKey:"AIzaSyCSUQoYmYbmbkKoIbDQcQhOxnada13rBWY",authDomain:"memory-c1192.firebaseapp.com",projectId:"memory-c1192",storageBucket:"memory-c1192.appspot.com",messagingSenderId:"320978503728",appId:"1:320978503728:web:49c1ef1f72cd9a595745f5",measurementId:"G-QP4M89SW8F",databaseURL:"https://memory-c1192-default-rtdb.europe-west1.firebasedatabase.app/"}));let r=Array(i.length).fill(0);i=i.map(((e,t)=>({...e,bgColor:`rgb(${Math.floor(256*Math.random())}, ${Math.floor(256*Math.random())}, ${Math.floor(256*Math.random())}, 0.6)`,index:t})));let o=!0,a=!0,l=!0;function h(e){if(0==l)return;l=!1;let t=r[e];setTimeout((()=>{if(Ro(To(s,"images"),(e=>{const t=e.val();t&&n(1,r=Object.values(t))})),t-r[e]>=260)for(let t=0;t<260;t++)ko(To(s,`images/${e}`),r[e]+1);else if(t-r[e]<=-260)for(let t=0;t<260;t++)ko(To(s,`images/${e}`),r[e]-1);l=!0}),3e4)}function c(e){!1!==o&&(o=!1,r[e],ko(To(s,`images/${e}`),r[e]+1),setTimeout((()=>{o=!0}),100))}function u(e){!1!==a&&(a=!1,r[e],ko(To(s,`images/${e}`),r[e]-1),setTimeout((()=>{a=!0}),100))}y((()=>{Ro(To(s,"images"),(e=>{const t=e.val();t&&n(1,r=Object.values(t))}))}));return[i,r,h,c,u,e=>{c(e.index),h(e.index)},e=>{u(e.index),h(e.index)}]}$n.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},$n.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},function(e){!function(e){mt=e}("9.22.1"),Xe(new ge("database",((e,{instanceIdentifier:t})=>Mo(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),nt(ft,gt,e),nt(ft,gt,"esm2017")}();return new class extends O{constructor(e){super(),A(this,e,Bo,Wo,r,{})}}({target:document.body})}();
