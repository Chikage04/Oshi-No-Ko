...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class W extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const B=function(e){const t=$(e);return U.encodeByteArray(t,!0)},j=function(e){return B(e).replace(/\./g,"")},H=function(e){try{return U.decodeString(e,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
class je{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const He="@firebase/app",ze="0.9.8",Ve=new Te("@firebase/app"),Ye="[DEFAULT]",Ke={[He]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},Ge=new Map,Qe=new Map;function Je(e,t){try{e.container.addComponent(t)}catch(n){Ve.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Xe(e){const t=e.name;if(Qe.has(t))return Ve.debug(`There were multiple attempts to register component ${t}.`),!1;Qe.set(t,e);for(const t of Ge.values())Je(t,e);return!0}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const it="firebase-heartbeat-database",st=1,rt="firebase-heartbeat-store";let ot=null;function at(){return ot||(ot=function(e,t,{blocked:n,upgrade:i,blocking:s,terminated:r}={}){const o=indexedDB.open(e,t),a=Fe(o);return i&&o.addEventListener("upgradeneeded",(e=>{i(Fe(o.result),e.oldVersion,e.newVersion,Fe(o.transaction))})),n&&o.addEventListener("blocked",(()=>n())),a.then((e=>{r&&e.addEventListener("close",(()=>r())),s&&e.addEventListener("versionchange",(()=>s()))})).catch((()=>{})),a}(it,st,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(rt)}}).catch((e=>{throw Ze.create("idb-open",{originalErrorMessage:e.message})}))),ot}async function lt(e,t){try{const n=(await at()).transaction(rt,"readwrite"),i=n.objectStore(rt);return await i.put(t,ht(e)),n.done}catch(e){if(e instanceof ee)Ve.warn(e.message);else{const t=Ze.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});Ve.warn(t.message)}}}function ht(e){return`${e.name}!${e.options.appId}`}
/**
     * @license
     * Copyright 2021 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */var _t;_t="",Xe(new ge("platform-logger",(e=>new je(e)),"PRIVATE")),Xe(new ge("heartbeat",(e=>new ct(e)),"PRIVATE")),nt(He,ze,_t),nt(He,ze,"esm2017"),nt("fire-js","");
/**
     * @license
     ...
     * limitations under the License.
     */
nt("firebase","9.20.0","app");const ft="@firebase/database",gt="0.14.4";
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */let Bn;class jn extends Wn{static get __EMPTY_NODE(){return Bn}static set __EMPTY_NODE(e){Bn=e}compare(e,t){return Ft(e.name,t.name)}isDefinedOn(e){throw q("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return Un.MIN}maxPost(){return new Un(Lt,Bn)}makePost(e,t){return F("string"==typeof e,"KeyIndex indexValue must always be a string."),new Un(e,Bn)}toString(){return".key"}}const Hn=new jn;
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function xi(){return{value:null,children:new Map}}function Pi(e,t,n){if(Pn(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{const i=In(t);e.children.has(i)||e.children.set(i,xi());Pi(e.children.get(i),t=Tn(t),n)}}function Ri(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach(((e,n)=>{t(n,e)}))}
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(e,((e,i)=>{Ri(i,new wn(t.toString()+"/"+e),n)}))}class Di{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Bt(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Ai{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Di(e);const n=1e4+2e4*Math.random();Yt(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;Bt(e,((e,i)=>{i>0&&oe(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),Yt(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */!function(e){e[e.OVERWRITE=0]="OVERWRITE",e[e.MERGE=1]="MERGE",e[e.ACK_USER_WRITE=2]="ACK_USER_WRITE",e[e.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"}(Oi||(Oi={}));class Li{constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Oi.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}operationForChild(e){if(Pn(this.path)){if(null!=this.affectedTree.value)return F(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new wn(e));return new Li(bn(),t,this.revert)}}return F(In(this.path)===e,"operationForChild called for unrelated child."),new Li(Tn(this.path),this.affectedTree,this.revert)}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Fi{constructor(e,t){this.source=e,this.path=t,this.type=Oi.LISTEN_COMPLETE}operationForChild(e){return Pn(this.path)?new Fi(this.source,bn()):new Fi(this.source,Tn(this.path))}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class qi{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Oi.OVERWRITE}operationForChild(e){return Pn(this.path)?new qi(this.source,bn(),this.snap.getImmediateChild(e)):new qi(this.source,Tn(this.path),this.snap)}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class $i{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Oi.MERGE}operationForChild(e){if(Pn(this.path)){const t=this.children.subtree(new wn(e));return t.isEmpty()?null:t.value?new qi(this.source,bn(),t.value):new $i(this.source,bn(),t)}return F(In(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new $i(this.source,Tn(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Wi{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Bi(e,t,n,i,s,r){const o=i.filter((e=>e.type===n));o.sort(((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw q("Should only compare child_ events.");const i=new Un(t.childName,t.snapshotNode),s=new Un(n.childName,n.snapshotNode);return e.index_.compare(i,s)}
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(e,t,n))),o.forEach((n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,r);s.forEach((s=>{s.respondsTo(n.type)&&t.push(s.createEvent(i,e.query_))}))}))}function ji(e,t){return{eventCache:e,serverCache:t}}function Hi(e,t,n,i){return ji(new Ui(t,n,i),e.serverCache)}function zi(e,t,n,i){return ji(e.eventCache,new Ui(t,n,i))}function Vi(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Yi(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */let Ki;class Gi{constructor(e,t=(()=>(Ki||(Ki=new Yn(qt)),Ki))()){this.value=e,this.children=t}static fromObject(e){let t=new Gi(null);return Bt(e,((e,n)=>{t=t.set(new wn(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:bn(),value:this.value};if(Pn(e))return null;{const n=In(e),i=this.children.get(n);if(null!==i){const s=i.findRootMostMatchingPathAndValue(Tn(e),t);if(null!=s){return{path:xn(new wn(n),s.path),value:s.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Pn(e))return this;{const t=In(e),n=this.children.get(t);return null!==n?n.subtree(Tn(e)):new Gi(null)}}set(e,t){if(Pn(e))return new Gi(t,this.children);{const n=In(e),i=(this.children.get(n)||new Gi(null)).set(Tn(e),t),s=this.children.insert(n,i);return new Gi(this.value,s)}}remove(e){if(Pn(e))return this.children.isEmpty()?new Gi(null):new Gi(null,this.children);{const t=In(e),n=this.children.get(t);if(n){const i=n.remove(Tn(e));let s;return s=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&s.isEmpty()?new Gi(null):new Gi(this.value,s)}return this}}get(e){if(Pn(e))return this.value;{const t=In(e),n=this.children.get(t);return n?n.get(Tn(e)):null}}setTree(e,t){if(Pn(e))return t;{const n=In(e),i=(this.children.get(n)||new Gi(null)).setTree(Tn(e),t);let s;return s=i.isEmpty()?this.children.remove(n):this.children.insert(n,i),new Gi(this.value,s)}}fold(e){return this.fold_(bn(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((i,s)=>{n[i]=s.fold_(xn(e,i),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,bn(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(Pn(e))return null;{const i=In(e),s=this.children.get(i);return s?s.findOnPath_(Tn(e),xn(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,bn(),t)}foreachOnPath_(e,t,n){if(Pn(e))return this;{this.value&&n(t,this.value);const i=In(e),s=this.children.get(i);return s?s.foreachOnPath_(Tn(e),xn(t,i),n):new Gi(null)}}foreach(e){this.foreach_(bn(),e)}foreach_(e,t){this.children.inorderTraversal(((n,i)=>{i.foreach_(xn(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Qi{constructor(e){this.writeTree_=e}static empty(){return new Qi(new Gi(null))}}function Ji(e,t,n){if(Pn(t))return new Qi(new Gi(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const s=i.path;let r=i.value;const o=Rn(s,t);return r=r.updateChild(o,n),new Qi(e.writeTree_.set(s,r))}{const i=new Gi(n),s=e.writeTree_.setTree(t,i);return new Qi(s)}}}function Xi(e,t,n){let i=e;return Bt(n,((e,n)=>{i=Ji(i,xn(t,e),n)})),i}function Zi(e,t){if(Pn(t))return Qi.empty();{const n=e.writeTree_.setTree(t,new Gi(null));return new Qi(n)}}function es(e,t){return null!=ts(e,t)}function ts(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(Rn(n.path,t)):null}function ns(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(ii,((e,n)=>{t.push(new Un(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new Un(e,n.value))})),t}function is(e,t){if(Pn(t))return e;{const n=ts(e,t);return new Qi(null!=n?new Gi(n):e.writeTree_.subtree(t))}}function ss(e){return e.writeTree_.isEmpty()}function rs(e,t){return os(bn(),e.writeTree_,t)}function os(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,s)=>{".priority"===t?(F(null!==s.value,"Priority writes must always be leaf nodes"),i=s.value):n=os(xn(e,t),s,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(xn(e,".priority"),i)),n}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Es(e,t,n,i,s){const r=new ws;let o,a;if(n.type===Oi.OVERWRITE){const l=n;l.source.fromUser?o=ks(e,t,l.path,l.snap,i,s,r):(F(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!Pn(l.path),o=Ss(e,t,l.path,l.snap,i,s,a,r))}else if(n.type===Oi.MERGE){const l=n;l.source.fromUser?o=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,l)=>{const h=xn(n,i);Ns(t,In(h))&&(a=ks(e,a,h,l,s,r,o))})),i.foreach(((i,l)=>{const h=xn(n,i);Ns(t,In(h))||(a=ks(e,a,h,l,s,r,o))})),a}(e,t,l.path,l.children,i,s,r):(F(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),o=Ps(e,t,l.path,l.children,i,s,a,r))}else if(n.type===Oi.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,s,r){let o;if(null!=gs(i,n))return t;{const a=new Is(i,t,s),l=t.eventCache.getNode();let h;if(Pn(n)||".priority"===In(n)){let n;if(t.serverCache.isFullyInitialized())n=ps(i,Yi(t));else{const e=t.serverCache.getNode();F(e instanceof ui,"serverChildren would be complete if leaf node"),n=_s(i,e)}h=e.filter.updateFullNode(l,n,r)}else{const s=In(n);let c=ys(i,s,t.serverCache);null==c&&t.serverCache.isCompleteForChild(s)&&(c=l.getImmediateChild(s)),h=null!=c?e.filter.updateChild(l,s,c,Tn(n),a,r):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(l,s,ui.EMPTY_NODE,Tn(n),a,r):l,h.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=ps(i,Yi(t)),o.isLeafNode()&&(h=e.filter.updateFullNode(h,o,r)))}return o=t.serverCache.isFullyInitialized()||null!=gs(i,bn()),Hi(t,h,o,e.filter.filtersNodes())}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
class Br{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function jr(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Dn(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Hr(e,t,n){jr(e,n),Vr(e,(e=>Dn(e,t)))}function zr(e,t,n){jr(e,n),Vr(e,(e=>An(e,t)||An(t,e)))}function Vr(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(Yr(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Yr(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();kt&&xt("event: "+n.toString()),Vt(i)}}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
const Ro="FIREBASE_DATABASE_EMULATOR_HOST",Do={};let Ao=!1;function Oo(e,t,n,i,s){let r=i||e.options.databaseURL;void 0===r&&(e.options.projectId||Dt("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),xt("Using default host for project ",e.options.projectId),r=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=mo(r,s),h=l.repoInfo;"undefined"!=typeof process&&process.env&&(a=process.env[Ro]),a?(o=!0,r=`http://${a}?ns=${h.namespace}`,l=mo(r,s),h=l.repoInfo):o=!l.repoInfo.secure;const c=s&&o?new Qt(Qt.OWNER):new Gt(e.name,e.options,t);Wr("Invalid Firebase Database URL",l),Pn(l.path)||Dt("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let s=Do[t.name];s||(s={},Do[t.name]=s);let r=s[e.toURLString()];r&&Dt("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return r=new Qr(e,Ao,n,i),s[e.toURLString()]=r,r}(h,e,c,new Kt(e.name,n));return new Lo(u,e)}function Mo(e,t){const n=Do[t];n&&n[e.key]===e||Dt(`Database ${t}(${e.repoInfo_}) has already been deleted.`),function(e){e.persistentConnection_&&e.persistentConnection_.interrupt(Kr)}(e),delete n[e.key]}class Lo{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Jr(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Io(this._repo,bn())),this._rootInternal}_delete(){return null!==this._rootInternal&&(Mo(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Dt("Cannot call "+e+" on a deleted database.")}}function Fo(e=function(e=Ye){const t=Ge.get(e);if(!t&&e===Ye)return tt();if(!t)throw Ze.create("no-app",{appName:e});return t}(),t){const n=function(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}(e,"database").getImmediate({identifier:t});if(!n._instanceStarted){const e=G("database");e&&function(e,t,n,i={}){e=fe(e),e._checkNotDeleted("useEmulator"),e._instanceStarted&&Dt("Cannot call useEmulator() after instance has already been initialized.");const s=e._repoInternal;let r;if(s.repoInfo_.nodeAdmin)i.mockUserToken&&Dt('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new Qt(Qt.OWNER);else if(i.mockUserToken){const t="string"==typeof i.mockUserToken?i.mockUserToken:function(e,t){if(e.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const n=t||"demo-project",i=e.iat||0,s=e.sub||e.user_id;if(!s)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const r=Object.assign({iss:`https://securetoken.google.com/${n}`,aud:n,iat:i,exp:i+3600,auth_time:i,sub:s,user_id:s,firebase:{sign_in_provider:"custom",identities:{}}},e);return[j(JSON.stringify({alg:"none",type:"JWT"})),j(JSON.stringify(r)),""].join(".")}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(n,...e)}return n}function qo(e,t,n){const i=e.slice();return i[10]=t[n],i}function $o(e){let t,n,s,r,o,a,m,y,v,C,w,b,I,E,T,S,k=`Score = ${e[1][e[10].index]}`;function N(){return e[4](e[10])}function x(){return e[5](e[10])}return{c(){t=d("div"),n=d("div"),s=d("button"),s.textContent="Yes",r=_(),o=d("button"),o.textContent="No",a=_(),m=d("img"),v=_(),C=d("span"),w=p(k),b=_(),g(s,"class","svelte-1x1u64n"),g(o,"class","svelte-1x1u64n"),g(n,"class","buttons svelte-1x1u64n"),l(m.src,y=e[10].src)||g(m,"src",y),g(m,"data-",""),g(m,"alt","jsp"),g(m,"class","svelte-1x1u64n"),g(C,"class","svelte-1x1u64n"),g(t,"class","box svelte-1x1u64n"),g(t,"id",I=`box-${e[10].index}`),g(t,"style",E=`background-color: ${e[10].bgColor}`)},m(e,i){c(e,t,i),h(t,n),h(n,s),h(n,r),h(n,o),h(t,a),h(t,m),h(t,v),h(t,C),h(C,w),h(t,b),T||(S=[f(s,"click",N),f(o,"click",x)],T=!0)},p(n,i){e=n,1&i&&!l(m.src,y=e[10].src)&&g(m,"src",y),3&i&&k!==(k=`Score = ${e[1][e[10].index]}`)&&function(e,t){t=""+t,e.data!==t&&(e.data=t)}(w,k),1&i&&I!==(I=`box-${e[10].index}`)&&g(t,"id",I),1&i&&E!==(E=`background-color: ${e[10].bgColor}`)&&g(t,"style",E)},d(e){e&&u(t),T=!1,i(S)}}}function Uo(t){let n,i=t[0],s=[];for(let e=0;e<i.length;e+=1)s[e]=$o(qo(t,i,e));return{c(){n=d("main");for(let e=0;e<s.length;e+=1)s[e].c();g(n,"class","svelte-1x1u64n")},m(e,t){c(e,n,t);for(let e=0;e<s.length;e+=1)s[e]&&s[e].m(n,null)},p(e,[t]){if(15&t){let r;for(i=e[0],r=0;r<i.length;r+=1){const o=qo(e,i,r);s[r]?s[r].p(o,t):(s[r]=$o(o),s[r].c(),s[r].m(n,null))}for(;r<s.length;r+=1)s[r].d(1);s.length=i.length}},i:e,o:e,d(e){e&&u(n),function(e,t){for(let n=0;n<e.length;n+=1)e[n]&&e[n].d(t)}(s,e)}}}function Wo(e,t,n){let i=[{src:"https://pbs.twimg.com/media/FlyK1nFaYAA1hJC.jpg"},{src:"https://m.media-amazon.com/images/I/71bgnycGk6L.jpg"},{src:"https://www.manga-news.com/public/images/vols/Oshi-no-Ko-11-jp.jpg"},{src:"https://www.manga-news.com/public/images/dvd/oshi-no-ko-anime-visual-2.jpg"},{src:"https://preview.redd.it/fcy3hcdm6y281.jpg?auto=webp&s=b00dcfd6cbc8dcf4c8bc531e1cc7a336f9beca18"}];const s=Fo(tt({apiKey:"AIzaSyCSUQoYmYbmbkKoIbDQcQhOxnada13rBWY",authDomain:"memory-c1192.firebaseapp.com",projectId:"memory-c1192",storageBucket:"memory-c1192.appspot.com",messagingSenderId:"320978503728",appId:"1:320978503728:web:49c1ef1f72cd9a595745f5",measurementId:"G-QP4M89SW8F",databaseURL:"https://memory-c1192-default-rtdb.europe-west1.firebasedatabase.app/"}));let r=Array(i.length).fill(0);i=i.map(((e,t)=>({...e,bgColor:`rgb(${Math.floor(256*Math.random())}, ${Math.floor(256*Math.random())}, ${Math.floor(256*Math.random())}, 0.6)`,index:t})));let o=!0;function a(e){!1!==o&&(o=!1,ko(To(s,`images/${e}`),r[e]+1),setTimeout((()=>{o=!0}),40))}function l(e){!1!==o&&(o=!1,ko(To(s,`images/${e}`),r[e]-1),setTimeout((()=>{o=!0}),40))}y((()=>{!function(e,t,n,i){Po(e,"value",t,n,i)}(To(s,"images"),(e=>{const t=e.val();t&&n(1,r=Object.values(t))}))}));return[i,r,a,l,e=>{a(e.index)},e=>{l(e.index)}]}$n.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},$n.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},function(e){!function(e){mt=e}("9.20.0"),Xe(new ge("database",((e,{instanceIdentifier:t})=>Oo(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),nt(ft,gt,e),nt(ft,gt,"esm2017")}();return new class extends O{constructor(e){super(),A(this,e,Wo,Uo,r,{})}}({target:document.body,props:{name:"world"}})}();
