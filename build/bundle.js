...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(n,...e)}return n}function qo(e,t,n){const i=e.slice();return i[9]=t[n],i}function $o(e){let t,n,s,r,o,a,m,y,v,C,w,b,I,E,T,S,k=`Score = ${e[1][e[9].index]}`;function N(){return e[4](e[9])}function x(){return e[5](e[9])}return{c(){t=d("div"),n=d("div"),s=d("button"),s.textContent="Yes",r=_(),o=d("button"),o.textContent="No",a=_(),m=d("img"),v=_(),C=d("span"),w=p(k),b=_(),g(s,"class","svelte-1x1u64n"),g(o,"class","svelte-1x1u64n"),g(n,"class","buttons svelte-1x1u64n"),l(m.src,y=e[9].src)||g(m,"src",y),g(m,"data-",""),g(m,"alt","jsp"),g(m,"class","svelte-1x1u64n"),g(C,"class","svelte-1x1u64n"),g(t,"class","box svelte-1x1u64n"),g(t,"id",I=`box-${e[9].index}`),g(t,"style",E=`background-color: ${e[9].bgColor}`)},m(e,i){c(e,t,i),h(t,n),h(n,s),h(n,r),h(n,o),h(t,a),h(t,m),h(t,v),h(t,C),h(C,w),h(t,b),T||(S=[f(s,"click",N),f(o,"click",x)],T=!0)},p(n,i){e=n,1&i&&!l(m.src,y=e[9].src)&&g(m,"src",y),3&i&&k!==(k=`Score = ${e[1][e[9].index]}`)&&function(e,t){t=""+t,e.data!==t&&(e.data=t)}(w,k),1&i&&I!==(I=`box-${e[9].index}`)&&g(t,"id",I),1&i&&E!==(E=`background-color: ${e[9].bgColor}`)&&g(t,"style",E)},d(e){e&&u(t),T=!1,i(S)}}}function Uo(t){let n,i=t[0],s=[];for(let e=0;e<i.length;e+=1)s[e]=$o(qo(t,i,e));return{c(){n=d("main");for(let e=0;e<s.length;e+=1)s[e].c();g(n,"class","svelte-1x1u64n")},m(e,t){c(e,n,t);for(let e=0;e<s.length;e+=1)s[e]&&s[e].m(n,null)},p(e,[t]){if(15&t){let r;for(i=e[0],r=0;r<i.length;r+=1){const o=qo(e,i,r);s[r]?s[r].p(o,t):(s[r]=$o(o),s[r].c(),s[r].m(n,null))}for(;r<s.length;r+=1)s[r].d(1);s.length=i.length}},i:e,o:e,d(e){e&&u(n),function(e,t){for(let n=0;n<e.length;n+=1)e[n]&&e[n].d(t)}(s,e)}}}function Wo(e,t,n){let i=[{src:"https://pbs.twimg.com/media/FlyK1nFaYAA1hJC.jpg"},{src:"https://m.media-amazon.com/images/I/71bgnycGk6L.jpg"},{src:"https://www.manga-news.com/public/images/vols/Oshi-no-Ko-11-jp.jpg"},{src:"https://www.manga-news.com/public/images/dvd/oshi-no-ko-anime-visual-2.jpg"},{src:"https://preview.redd.it/fcy3hcdm6y281.jpg?auto=webp&s=b00dcfd6cbc8dcf4c8bc531e1cc7a336f9beca18"}];const s=Fo(tt({apiKey:"AIzaSyCSUQoYmYbmbkKoIbDQcQhOxnada13rBWY",authDomain:"memory-c1192.firebaseapp.com",projectId:"memory-c1192",storageBucket:"memory-c1192.appspot.com",messagingSenderId:"320978503728",appId:"1:320978503728:web:49c1ef1f72cd9a595745f5",measurementId:"G-QP4M89SW8F",databaseURL:"https://memory-c1192-default-rtdb.europe-west1.firebasedatabase.app/"}));let r=Array(i.length).fill(0);function o(e){ko(To(s,`images/${e}`),r[e]+1)}function a(e){ko(To(s,`images/${e}`),r[e]-1)}i=i.map(((e,t)=>({...e,bgColor:`rgb(${Math.floor(256*Math.random())}, ${Math.floor(256*Math.random())}, ${Math.floor(256*Math.random())}, 0.6)`,index:t}))),y((()=>{!function(e,t,n,i){Po(e,"value",t,n,i)}(To(s,"images"),(e=>{const t=e.val();t&&n(1,r=Object.values(t))}))}));return[i,r,o,a,e=>{o(e.index)},e=>{a(e.index)}]}$n.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},$n.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},function(e){!function(e){mt=e}("9.20.0"),Xe(new ge("database",((e,{instanceIdentifier:t})=>Oo(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),nt(ft,gt,e),nt(ft,gt,"esm2017")}();return new class extends O{constructor(e){super(),A(this,e,Wo,Uo,r,{})}}({target:document.body,props:{name:"world"}})}();
