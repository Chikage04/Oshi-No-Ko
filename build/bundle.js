...
/**
     ...
     * limitations under the License.
     */
class Br{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function jr(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Dn(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Hr(e,t,n){jr(e,n),Vr(e,(e=>Dn(e,t)))}function zr(e,t,n){jr(e,n),Vr(e,(e=>An(e,t)||An(t,e)))}function Vr(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(Yr(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Yr(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();kt&&Pt("event: "+n.toString()),Vt(i)}}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
